...
fun GetMorphemes(
  ...
  for (row in morphemes) {
    ...
    html.append("    <td><input type='text' name='l2${row.morphemeId}' value='${escapeHTML(row.l2)}' data-row-id='${row.morphemeId}' class='ar-qalam'></td>\n")
    html.append("    <td id='ar-buckwalter-${row.morphemeId}'></td>\n")
    html.append("    <td>${row.gloss}</td>\n")
    html.append("    <td><input type='submit' name='saveMorpheme${row.morphemeId}' value='Save'></td>\n")
  ...
  html.append("    <th><input type='text' name='l2' data-row-id='new' class='ar-qalam'></td>\n")
  html.append("    <th id='ar-buckwalter-new'></td>\n")
