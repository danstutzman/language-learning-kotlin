...
fun handleGet(
  ...
  val infs = listOf(
    Inf(0, "comer",     "eat",    "ate"),
    Inf(0, "conocer",   "know",   "knew"),
    Inf(0, "dar",       "give",   "gave"),
    Inf(0, "decir",     "say",    "said"),
    Inf(0, "empezar",   "start",  "started"),
    Inf(0, "enviar",    "send",   "sent"),
    Inf(0, "estar",     "be",     "was"),
    Inf(0, "hacer",     "do",     "did"),
    Inf(0, "ir",        "go",     "went"),
    Inf(0, "parecer",   "seem",   "seemed"),
    Inf(0, "poner",     "put",    "put"),
    Inf(0, "preguntar", "ask",    "asked"),
    Inf(0, "saber",     "know",   "knew"),
    Inf(0, "salir",     "go out", "went out"),
    Inf(0, "ser",       "be",     "was"),
    Inf(0, "tener",     "have",   "had"),
    Inf(0, "ver",       "see",    "saw"),
    Inf(0, "venir",     "come",   "came")
